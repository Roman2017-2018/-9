...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                // Start the process.
                myProcess = Process.Start("C:\\Users\\роман\\Desktop\\23.docx");
                ...
                while (!myProcess.WaitForInputIdle());
                {
                    ...
                    Console.WriteLine();
                    Console.WriteLine("Всё збс прога работает");
            ...
            //var rocess = Process.Start("E:\\Qt\\Arduino\\arduino.exe");
            //rocess.WaitForExit();
